...
class NetDeviceQueue : public Object
{
  ...
  private:
    ...
    Ptr<NetDeviceQueueInterface> m_ndqi; //!< the NetDeviceQueueInterface of this NetDeviceQueue
...
class NetDeviceQueueInterface : public Object
{
  public:
    ...
    /**
     * \brief Set the mmu pointer attached to this interface.
     */
    void SetMmu(Ptr<SwitchMmu> mmu);

    /**
     * \brief Get the mmu pointer attached to this interface.
     */
  ...
  private:
    ...
    Ptr<SwitchMmu> m_mmu; //!< SwitchMmu attached to this interface
};
