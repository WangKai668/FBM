...
# h-16
packet_loss = np.array([66016.0, 31278.0, 20834.0, 20909.0, 20909.0, 18341.0]) / 1e3

avg_fct = np.array([5.566, 3.973, 2.669, 2.619, 2.619, 1.588])

p95_fct = np.array([15.095, 10.244, 5.250, 5.252, 5.252, 5.273])
...
# ax2.set_yticklabels(['5', '10', '20', '50', '100'])

ax2.set_yticks([10, 20, 40, 80])
ax2.set_yticklabels(['10', '20', '40', '80'])
