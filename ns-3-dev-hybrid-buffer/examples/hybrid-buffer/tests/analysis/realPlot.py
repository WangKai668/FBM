...
def test9_plot():
    ...
    # sj 0711号新跑的结果：
    ax_data = [2337370.0, 2332240.0, 2327920.0, 2322140.0, 2312080.0, 2318490.0] #websearch
    ax1_data = [2251070.0, 2244220.0, 2240390.0, 2237880.0, 2234080.0, 2243750.0] #fbhdp
    ax2_data = [2512330.0, 2503980.0, 2492380.0, 2468330.0, 2465020.0, 2481750.0] #websearch+incast 1
    ax3_data = [2422810.0, 2409930.0, 2397400.0, 2381190.0, 2375670.0, 2394850.0] #fbhdp+incast    1
