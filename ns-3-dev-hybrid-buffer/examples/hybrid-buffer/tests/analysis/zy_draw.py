...
# 片外绘制丢包率
Value = 1000
hw_loss_packet = '/home/dell6/yrf/pba-xzx/ns-3-dev-hybrid-buffer/examples/hybrid-buffer/tests/data/BMS/tc2-05/loss_packet.csv'
...
path = '/home/dell6/yrf/pba-xzx/ns-3-dev-hybrid-buffer/examples/hybrid-buffer/tests/data1.pdf'
plt.savefig(path)
plt.clf()
