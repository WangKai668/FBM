...
main(int argc, char* argv[])
{
    ...
    using namespace std;
    simHelper.AddFlow(2, 0, Seconds(0.0000), Seconds(0.2), DataRate("2000Gbps"), 150*1000*1000); // 50Gbps*25ms=150MB
    simHelper.AddFlow(3, 0, Seconds(0.0000), Seconds(0.2), DataRate("2000Gbps"), 150*1000*1000);
