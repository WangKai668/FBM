...
main(int argc, char* argv[])
{
    ...
    for (int i = 1; i<=20; i++){
        ...
        simHelper.AddFlow(i, 0, Seconds(0.000), Seconds(0.2), DataRate("2000Gbps"), 1*1000*1000);
    }
    ...
    // simHelper.AddFlow(5, 1, Seconds(0.0000), Seconds(0.2), DataRate("2000Gbps"), 20*1000*1000);
    // simHelper.AddFlow(6, 1, Seconds(0.0000), Seconds(0.2), DataRate("2000Gbps"), 20*1000*1000);

    // for (int i = 7; i<=7+9-1; i++){
    //     // simHelper.AddFlow(i, 0, Seconds(0.0000), Seconds(0.0003), DataRate("2000Gbps"));
    //     simHelper.AddFlow(i, 1, Seconds(0.006), Seconds(0.2), DataRate("2000Gbps"), 250*1000);
    // }

    // for (int i = 13; i<=23; i++){
    //     // simHelper.AddFlow(i, 0, Seconds(0.0000), Seconds(0.0003), DataRate("2000Gbps"));
    //     simHelper.AddFlow(i, 0, Seconds(0.000), Seconds(0.2), DataRate("2000Gbps"), 200*1000);
    // }
